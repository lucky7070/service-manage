...
const email = check("email", "Valid email is required.").exists().not().isEmpty().isEmail().isLength({ min: 2, max: 100 });
...
const mobile = check("mobile", "Mobile is required.").exists().not().isEmpty().isLength({ min: 10, max: 15 });
