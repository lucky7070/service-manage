...
const permissions = [201, 205, 101, 105, 102, 202, 203, 103, 104, 204, 100, 301, 302, 303, 304, 311, 312, 313, 314, 321, 322, 323, 324, 325, 326, 327, 328, 331, 332, 333, 334, 335, 336, 337, 338, 339, 3310, 341, 342, 343, 344, 345, 346, 347, 351, 352, 353, 354, 361, 362, 363, 364, 371, 372, 373, 374, 377, 376, 375, 378, 381, 382, 383, 384, 391, 392, 393, 394, 401, 402, 403, 413, 412, 411, 414, 421, 422, 423, 424, 431, 432, 433, 434, 441, 442, 443, 444, 451, 452, 453, 454, 455, 457, 458, 461, 462, 463, 464];
...
export async function seedDefaultAdmin() {
    const role = await Role.findOneAndUpdate(
        ...
        { $setOnInsert: { name: "Super Admin" }, $set: { isActive: true, deletedAt: null }, $addToSet: { permissions: { $each: permissions } } },
    ...
    if (existing) {
        await Admin.updateOne({ _id: existing._id }, { $addToSet: { permissions: { $each: permissions } } });
