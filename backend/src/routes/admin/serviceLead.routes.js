...
import { assignServiceLead, cancelServiceLead, exportServiceLeads, getServiceLeadDetail, listServiceLeads } from "../../controller/admin/serviceLead.controller.js";
import { validator } from "../../libraries/validator.js";

const router = Router();

router.get("/service-leads/export", exportServiceLeads);
