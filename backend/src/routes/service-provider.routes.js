...
import { sendOtp, register, login, profile, logout, deleteServiceProviderAccount, getServiceProviderDashboard, getProviderNotificationUnreadCount, getWorkPhotos, uploadWorkPhotos, deleteWorkPhoto, reorderWorkPhotos, listProviderBookings, listProviderNotifications, getProviderBooking, listProviderBookingMessages, sendProviderBookingMessage, setBookingQuote, cancelProviderBooking, startProviderBooking, sendBookingCompletionOtp, completeProviderBooking, submitProviderBookingFeedback, markAllProviderNotificationsRead, listMyReferrals, listMyAreas, updateMyAreas } from "../controller/provider/auth.controller.js";
...
router.get("/areas", listMyAreas);
router.put("/profile/areas", validator("service-provider-areas-update"), updateMyAreas);
