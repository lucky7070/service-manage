                ...
                <div className="fixed inset-0 z-999 flex items-center justify-center bg-black/60 p-4 backdrop-blur-[2px]">
                    <div data-slot="card" className="w-full max-w-md rounded-xl border border-indigo-100 bg-white text-slate-900 shadow-xl transition-shadow duration-200 dark:border-indigo-100 dark:bg-slate-900 dark:text-slate-100">
                        <div data-slot="card-header" className="flex flex-col space-y-1.5 p-6">
                            <h3 className="font-semibold leading-none tracking-tight">{open === "add" ? "Create State" : "Update State"}</h3>
                            <p className="text-sm text-muted-foreground">Select country, then add state name and status.</p>
                        </div>
                                ...
                                {({ isSubmitting, setFieldValue }) => (
                                    <Form className="space-y-3">
                                        <div className="space-y-2">
                                            <label htmlFor="state-country" data-slot="label" className="flex items-center gap-2 text-sm font-medium leading-none select-none">
                                                Country
                                            </label>
                                            <AsyncFormSelect
                                        ...
                                        <div className="space-y-2">
                                            <label htmlFor="state-name" data-slot="label" className="flex items-center gap-2 text-sm font-medium leading-none select-none">
                                                State Name
                                            </label>
                                            <Field
                                                id="state-name"
                                        ...
                                        <div className="space-y-2">
                                            <label htmlFor="state-status" data-slot="label" className="flex items-center gap-2 text-sm font-medium leading-none select-none">
                                                Status
                                            </label>
                                            <Field as="select"
                                                id="state-status"
