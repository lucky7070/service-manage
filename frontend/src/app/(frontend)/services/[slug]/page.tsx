...
import CategoryServiceTypeGrid from "@/components/front/CategoryServiceTypeGrid";
...
export default async function ServiceCategoryDetailPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return <section className="bg-white py-16 md:py-24">
        <div className="container mx-auto px-4">
            <div className="mx-auto max-w-6xl rounded-2xl border border-gray-100 bg-white p-6 shadow-sm md:p-8">
                <div className="flex justify-between items-start gap-2">
                    <div className="">
                        <div className="mb-5 size-20 overflow-hidden">
